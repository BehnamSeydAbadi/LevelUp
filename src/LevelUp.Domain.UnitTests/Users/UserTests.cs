...
public class UserTests
{
    ...
    [Fact(DisplayName =
        "There is a registered user, When the user performs an activity, Then it is done successfully")]
    public void There_Is_A_Registered_User_When_The_User_Performs_An_Activity_Then_It_Is_Done_Successfully()
    {
        var user = Builder<User>.CreateNew()
            .With(u => u.Profile = Builder<UserProfileValueObject>.CreateNew().Build())
            .Build();
